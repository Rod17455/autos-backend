...
mongoose
  ...
  .connect('mongodb+srv://emmanuelmoti19:AutosInnovacion_427@autos.mn0nf8y.mongodb.net/auto2023?retryWrites=true&w=majority')
  .then((x)=>{
...
const empleadoRuta = require('./routes/auto.route') // RUTA PARA LOS ENDPOINTS
const app = express()
...
app.use(cors())
app.use(express.static(path.join(__dirname,'dist/autos')))
app.use('/',express.static(path.join(__dirname,'dist/autos')))
